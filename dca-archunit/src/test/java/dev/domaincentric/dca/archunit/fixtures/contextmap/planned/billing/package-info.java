...
@ExternalUpstream(
    ...
    status = Upstream.Status.PLANNED,
    contractPackages = "dev.domaincentric.dca.archunit.fixtures.contextmap.planned.external.tax..")
package dev.domaincentric.dca.archunit.fixtures.contextmap.planned.billing;
