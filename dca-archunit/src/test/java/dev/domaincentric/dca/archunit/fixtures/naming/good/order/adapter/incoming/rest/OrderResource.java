package dev.domaincentric.dca.archunit.fixtures.naming.good.order.adapter.incoming.rest;

import dev.domaincentric.dca.archunit.fixtures.naming.good.order.application.placeorder.PlaceOrderCommand;
