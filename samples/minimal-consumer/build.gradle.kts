...
val buildingBlocksVersion = providers.gradleProperty("buildingBlocksVersion").getOrElse("0.1.0")
val archunitVersion = providers.gradleProperty("archunitVersion").getOrElse("0.1.0")
